...
const Testimonials = () => {
  ...
  return (
    <div className='md:pt-16 pt-10 pb-20 md:px-0 px-10'>
      <h1 style={{ lineHeight: '65px' }} className='md:text-4xl text-2xl py-10  text-center mb-12 font-semibold'><span className='text-[#504ED7]'>Reviews</span> of People Who Have <br className='md:block hidden' /> Found Jobs Through Job Seek</h1>
      <div>
      <ReviewCard

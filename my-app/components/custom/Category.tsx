const CategoryContainer = () => {
  ...
  const jobCategories: JobCategory[] = [
    ...
    },
    {
      ...
      icon: (
        <span role="img" aria-label="Frontend Developer">
          💻
        </span>
      ),
      color: "text-red-400",
    ...
    },
    {
      ...
      icon: (
        <span role="img" aria-label="Backend Developer">
          🖥️
        </span>
      ),
  ...
  return (
    <div className="bg-gray-100 py-20 md:px-16 px-8">
      <h1
        ...
        className="md:text-4xl text-3xl font-semibold text-center mb-10"
      >
        One Platform <br className="hidden md:block" /> Many{" "}
        <span className="text-[#504ED7]">Solutions</span>
      </h1>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  {category.jobsAvailable} job
                  {category.jobsAvailable !== 1 ? "s" : ""} available
                </p>
              </div>
            </div>
          ))}
